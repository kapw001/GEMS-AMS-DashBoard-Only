...
public class CenteredRadioImageButton extends android.support.v7.widget.AppCompatRadioButton {

    Drawable image;

    public CenteredRadioImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, cashkaro.com.dashboad.R.styleable.CompoundButton, 0, 0);
